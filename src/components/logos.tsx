export function MulticaLaunchLogo() {
  return (
    <svg viewBox="0 0 64 64" fill="none" aria-hidden="true">
      <defs>
        <linearGradient id="multica-border" x1="12" y1="12" x2="52" y2="52" gradientUnits="userSpaceOnUse">
          <stop stopColor="#c8ff5c" stopOpacity="0.6" />
          <stop offset="1" stopColor="#7effd8" stopOpacity="0.3" />
        </linearGradient>
        <radialGradient
          id="multica-bg"
          cx="0" cy="0" r="1"
        ...
        >
          ...
          <stop offset="0.6" stopColor="#0a1612" />
          <stop offset="1" stopColor="#071016" />
        </radialGradient>
      </defs>
      {/* Background square */}
      <rect x="4" y="4" width="56" height="56" rx="14" fill="url(#multica-bg)" />
      <rect x="4.75" y="4.75" width="54.5" height="54.5" rx="13.25" stroke="url(#multica-border)" strokeWidth="1.5" />
      {/* "M" letterform in lime green */}
      <path
        d="M17 44V22L32 36L47 22V44"
        stroke="#c8ff5c"
        strokeWidth="3.5"
        strokeLinecap="round"
