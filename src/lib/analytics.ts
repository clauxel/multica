...
const visitorStorageKey = 'multica-analytics-visitor-id'
const sessionStorageKey = 'multica-analytics-session'
const pendingEventsStorageKey = 'multica-analytics-pending-events'
